...
import { AUDIT_QUESTIONS } from '../lib/ai-audit/audit-questions';
...
const AIAuditSurvey: React.FC = () => {
    ...
    useEffect(() => {
        // Hide navbar/footer for full screen experience
